...
def is_white_image(image_name):
    image_path = "TempImages/" + image_name + ".jpg"
    numpy_array = get_image(image_path)
    ...
    if white_percentage < 0.75:
        ...
        # Save
        result.save("TempImages/" + image_name + "_inverted.jpg")
        return False
    else:
        return True
...
def get_text(image_name):
    ...
    #     image_path =  "TempImages/" + image_name + "_inverted.jpg"
...
image_path = "table_17"
output_str = get_text(image_path)